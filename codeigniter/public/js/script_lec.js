...
$('#add-col-assign1').click(function(){
	if ($('#assignment').attr('colspan') != 10){
		...
		$('#table-items-seatwork1').before($("<td contenteditable='true'></td>"));
		$('tr #table-seatwork-classStanding1').before($("<td contenteditable='true'></td>"));
	}
});
//DELETE ASSIGNMENT
...
$('#add-col-sw1').click(function(){
	if ($('#seatwork').attr('colspan') != 10){
		...
		$('#table-items-ex1').before($("<td contenteditable='true'></td>"));
		$('tr #table-exercise-classStanding1').before($("<td contenteditable='true'></td>"));
	}
});
//DELETE SEATWORK
...
$('#add-col-ex1').click(function(){
	if ($('#exercise').attr('colspan') != 10){
		...
		$('#table-items-rec1').before($("<td contenteditable='true'></td>"));
		$('tr #table-rec-classStanding1').before($("<td contenteditable='true'></td>"));
	}
});
//DELETE EXERCISE
...
$('#add-col-rec1').click(function(){
	if ($('#recitation').attr('colspan') != 10){
		...
		$('#table-items-classStanding1').before($("<td contenteditable='true'></td>"));
		$('tr #table-total-classStanding1').before($("<td contenteditable='true'></td>"));
	}
});
//DELETE RECITATION
...
$('#add-col-quiz1').click(function(){
	if ($('#quiz').attr('colspan') != 10){
		...
		$('#table-items-le1').before($("<td contenteditable='true'></td>"));
		$('tr #table-le-quizLong1').before($("<td contenteditable='true'></td>"));
	}
});
//DELETE QUIZZES
...
$('#add-col-le1').click(function(){
	if ($('#longexam').attr('colspan') != 5){
		...
		$('#table-items-quizLong1').before($("<td contenteditable='true'></td>"));
		$('tr #table-total-quizLong1').before($("<td contenteditable='true'></td>"));
	}
});
//DELETE LONG EXAM
...
$('#add-col-assign2').click(function(){
	if ($('#assignmentFinals').attr('colspan') != 10){
		...
		$('#table-items-seatwork2').before($("<td contenteditable='true'></td>"));
		$('tr #table-seatwork-classStanding2').before($("<td contenteditable='true'></td>"));
	}
});
//DELETE ASSIGNMENT
...
$('#add-col-sw2').click(function(){
	if ($('#seatworkFinals').attr('colspan') != 10){
		...
		$('#table-items-ex2').before($("<td contenteditable='true'></td>"));
		$('tr #table-exercise-classStanding2').before($("<td contenteditable='true'></td>"));
	}
});
//DELETE SEATWORK
...
$('#add-col-ex2').click(function(){
	if ($('#exerciseFinals').attr('colspan') != 10){
		...
		$('#table-items-rec2').before($("<td contenteditable='true'></td>"));
		$('tr #table-rec-classStanding2').before($("<td contenteditable='true'></td>"));
	}
});
//DELETE EXERCISE
...
$('#add-col-rec2').click(function(){
	if ($('#recitationFinals').attr('colspan') != 10){
		...
		$('#table-items-classStanding2').before($("<td contenteditable='true'></td>"));
		$('tr #table-total-classStanding2').before($("<td contenteditable='true'></td>"));
	}
});
//DELETE RECITATION
...
$('#add-col-quiz2').click(function(){
	if ($('#quizFinals').attr('colspan') != 10){
		...
		$('#table-items-le2').before($("<td contenteditable='true'></td>"));
		$('tr #table-le-quizLong2').before($("<td contenteditable='true'></td>"));
	}
});
//DELETE QUIZZES
...
$('#add-col-le2').click(function(){
	if ($('#longexamFinals').attr('colspan') != 5){
		...
		$('#table-items-quizLong2').before($("<td contenteditable='true'></td>"));
		$('tr #table-total-quizLong2').before($("<td contenteditable='true'></td>"));
	}
});
//DELETE LONG EXAM
